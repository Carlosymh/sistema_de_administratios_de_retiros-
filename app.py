          ...
          if len(request.form['valor'])>0:
            ...
            if 'datefilter' in request.form:
              if len(request.form['datefilter'])>0:
                ...
                cur= db_connection.cursor()
                # Read a single record
                sql = "SELECT * FROM retiros WHERE {} LIKE \'%{}%\' AND fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}".format(session['filtro_recibo'],session['valor_recibo'],session['datefilter_recibo'],session['SiteName'],row1,row2)
                cur.execute(sql)
                data = cur.fetchall()
                cur.close()
                ...
                cur= db_connection.cursor()
                # Read a single record
                sql = "SELECT * FROM retiros WHERE {} LIKE \'%{}%\' AND Site =\'{}\' LIMIT {}, {}".format(session['filtro_recibo'],session['valor_recibo'],session['SiteName'],row1,row2)
                cur.execute(sql)
                data = cur.fetchall()
                cur.close()
                return render_template('reportes/t_retiros.html',Datos = session,Infos =data)
              ...
              cur= db_connection.cursor()
              # Read a single record
              sql = "SELECT * FROM retiros WHERE {} LIKE \'%{}%\' WHERE Site =\'{}\' LIMIT {}, {}".format(session['filtro_recibo'],session['valor_recibo'],session['SiteName'],row1,row2)
              cur.execute(sql)
              data = cur.fetchall()
              cur.close()
              return render_template('reportes/t_retiros.html',Datos = session,Infos =data)
              ...
              if len(request.form['datefilter'])>0:
                if 'valor_recibo' in session:
                  if len(session['valor_recibo'])>0:
                    ...
                    cur= db_connection.cursor()
                    # Read a single record
                    sql = "SELECT * FROM retiros WHERE fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}".format(session['datefilter_recibo'],session['SiteName'],row1,row2)
                    cur.execute(sql)
                    data = cur.fetchall()
                    cur.close()
                    return render_template('reportes/t_retiros.html',Datos = session,Infos =data)
                ...
                if 'valor_recibo' in session:
                  ...
                  cur= db_connection.cursor()
                  # Read a single record
                  sql = "SELECT * FROM retiros WHERE Site =\'{}\' LIMIT {}, {}".format(session['SiteName'],row1,row2)
                  cur.execute(sql)
                  data = cur.fetchall()
                  cur.close()
                  return render_template('reportes/t_retiros.html',Datos = session,Infos =data)
          ...
          if len(request.form['valor'])>0:
            ...
            if 'datefilter' in request.form:
              if len(request.form['datefilter'])>0:
                ...
                cur= db_connection.cursor()
                # Read a single record
                sql = "SELECT * FROM donacion WHERE {} LIKE \'%{}%\' AND fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}".format(session['filtro_donacion'],session['valor_donacion'],session['datefilter_donacion'],session['SiteName'],row1,row2)
                cur.execute(sql)
                data = cur.fetchall()
                cur.close()
                ...
                cur= db_connection.cursor()
                # Read a single record
                sql = "SELECT * FROM donacion WHERE {} LIKE \'%{}%\' AND Site =\'{}\' LIMIT {}, {}".format(session['filtro_donacion'],session['valor_donacion'],session['SiteName'],row1,row2)
                cur.execute(sql)
                data = cur.fetchall()
                cur.close()
                return render_template('reportes/t_donacion.html',Datos = session,Infos =data)
              ...
              if len(request.form['datefilter'])>0:
                if 'valor_donacion' in session:
                  if len(session['valor_donacion'])>0:
                    ...
                    cur= db_connection.cursor()
                    # Read a single record
                    sql = "SELECT * FROM donacion WHERE fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}".format(session['datefilter_donacion'],session['SiteName'],row1,row2)
                    cur.execute(sql)
                    data = cur.fetchall()
                    cur.close()
                    return render_template('reportes/t_donacion.html',Datos = session,Infos =data)
                ...
                cur= db_connection.cursor()
                # Read a single record
                sql = "SELECT * FROM donacion WHERE Site =\'{}\' LIMIT {}, {}".format(session['SiteName'],row1,row2)
                cur.execute(sql)
                data = cur.fetchall()
                cur.close()
            else:
          ...
          if 'valor_donacion' in session:
            ...
            if 'datefilter_donacion' in session:
              if len(session['datefilter_donacion'])>0:
                ...
                db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
                cur= db_connection.cursor()
                cur.execute('SELECT * FROM donacion WHERE Site =\'{}\' LIMIT {}, {}'.format(session['SiteName'],row1,row2))
                data = cur.fetchall()
                cur.close()
                return render_template('reportes/t_donacion.html',Datos = session,Infos =data)
            else:
          ...
          if len(request.form['valor'])>0:
            ...
            if 'datefilter' in request.form:
              if len(request.form['datefilter'])>0:
                ...
                cur= db_connection.cursor()
                # Read a single record
                sql = "SELECT * FROM retirio_ingram WHERE {} LIKE \'%{}%\' AND fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}".format(session['filtro_ingram'],session['valor_ingram'],session['datefilter_ingram'],session['SiteName'],row1,row2)
                cur.execute(sql)
                data = cur.fetchall()
                cur.close()
                ...
                cur= db_connection.cursor()
                # Read a single record
                sql = "SELECT * FROM retirio_ingram WHERE {} LIKE \'%{}%\' AND Site =\'{}\' LIMIT {}, {}".format(session['filtro_ingram'],session['valor_ingram'],session['SiteName'],row1,row2)
                cur.execute(sql)
                data = cur.fetchall()
                cur.close()
                return render_template('reportes/t_ingram.html',Datos = session,Infos =data)
              ...
              if len(request.form['datefilter'])>0:
                if 'valor_ingram' in session:
                  if len(session['valor_ingram'])>0:
                    ...
                    cur= db_connection.cursor()
                    # Read a single record
                    sql = "SELECT * FROM retirio_ingram WHERE fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}".format(session['datefilter_ingram'],session['SiteName'],row1,row2)
                    cur.execute(sql)
                    data = cur.fetchall()
                    cur.close()
                    return render_template('reportes/t_ingram.html',Datos = session,Infos =data)
                ...
                cur= db_connection.cursor()
                # Read a single record
                sql = "SELECT * FROM retirio_ingram WHERE Site =\'{}\' LIMIT {}, {}".format(session['SiteName'],row1,row2)
                cur.execute(sql)
                data = cur.fetchall()
                cur.close()
            else:
      ...
      if len(session['valor_recibo'])>0:
        if 'datefilter_recibo' in session:
          if len(session['datefilter_recibo'])>0:
            ...
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM retiros WHERE {} LIKE \'%{}%\' AND fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}'.format(session['filtro_recibo'],session['valor_recibo'],session['datefilter_recibo'],session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
          else:
            link = connectBD()
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM retiros WHERE {} LIKE \'%{}%\' AND Site =\'{}\' LIMIT {}, {}'.format(session['filtro_recibo'],session['valor_recibo'],session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
        else:
          link = connectBD()
        ...
        if 'datefilter_recibo' in session:
          if len(session['datefilter_recibo'])>0:
            ...
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM retiros WHERE fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}'.format(session['datefilter_recibo'],session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
          else:
            link = connectBD()
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM retiros WHERE Site =\'{}\' LIMIT {}, {}'.format(session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
        else:
          link = connectBD()
      ...
      if len(session['valor_donacion'])>0:
        if 'datefilter_donacion' in session:
          if len(session['datefilter_donacion'])>0:
            ...
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM donacion WHERE {} LIKE \'%{}%\' AND fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}'.format(session['filtro_donacion'],session['valor_donacion'],session['datefilter_donacion'],session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
          else:
            link = connectBD()
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM donacion WHERE {} LIKE \'%{}%\' AND Site =\'{}\' LIMIT {}, {}'.format(session['filtro_donacion'],session['valor_donacion'],session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
        else:
          link = connectBD()
        ...
        if 'datefilter_donacion' in session:
          if len(session['datefilter_donacion'])>0:
            ...
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM donacion WHERE fecha BETWEEN \'{}\' AND Site =\'{}\' LIMIT {}, {}'.format(session['datefilter_donacion'],session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
          else:
            link = connectBD()
      ...
      if len(session['valor_ingram'])>0:
        if 'datefilter_ingram' in session:
          if len(session['datefilter'])>0:
            ...
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM retirio_ingram WHERE {} LIKE \'%{}%\' AND fecha BETWEEN \'{}\' AND Site =\'{}\'  LIMIT {}, {}'.format(session['filtro_ingram'],session['valor_ingram'],session['datefilter_ingram'],session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
          else:
            link = connectBD()
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM retirio_ingram WHERE {} LIKE \'%{}%\' AND Site =\'{}\'  LIMIT {}, {}'.format(session['filtro_ingram'],session['valor_ingram'],session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
        else:
          link = connectBD()
        ...
        if 'datefilter_ingram' in session:
          if len(session['datefilter_ingram'])>0:
            ...
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM retirio_ingram WHERE fecha BETWEEN \'{}\' AND Site =\'{}\'  LIMIT {}, {}'.format(session['datefilter_ingram'],session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
          else:
            link = connectBD()
            db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
            cur= db_connection.cursor()
            cur.execute('SELECT * FROM retirio_ingram WHERE Site =\'{}\'  LIMIT {}, {}'.format(session['SiteName'],row1,row2))
            data = cur.fetchall()
            cur.close()
        else:
          link = connectBD()
        ...
        if 'valor_solicitudrecibo' in session:
          ...
          if 'datefilter_solicitudrecibo' in session:
            if len(session['datefilter_solicitudrecibo'])>0:
              ...
              db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
              cur= db_connection.cursor()
              cur.execute('SELECT * FROM solicitud_retiros LIMIT {}, {}'.format(session['SiteName'],row1,row2))
              data = cur.fetchall()
              cur.close()
              return render_template('reportes/t_solicitudretiros.html',Datos = session,Infos =data)
          else:
          ...
          if 'valor_solicituddonacion' in session:
            if len(session['valor_solicituddonacion'])>0:
              ...
              if 'datefilter_solicituddonacion' in session:
                if len(session['datefilter_solicituddonacion'])>0:
                  ...
                  db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
                  cur= db_connection.cursor()
                  cur.execute('SELECT * FROM solicitud_donacion WHERE Fecha BETWEEN \'{}\' AND  Site =  \'{}\' LIMIT {}, {}'.format(session['datefilter_solicituddonacion'],session['SiteName'],row1,row2))
                  data = cur.fetchall()
                  cur.close()
                  return render_template('reportes/t_solicituddonacion.html',Datos = session,Infos =data)
                else:
            ...
            if 'datefilter_solicituddonacion' in session:
              if len(session['datefilter_solicituddonacion'])>0:
                ...
                db_connection = pymysql.connect(host=link[0], port=link[1], user=link[2], passwd=link[3], db=link[4]) 
                cur= db_connection.cursor()
                cur.execute('SELECT * FROM solicitud_donacion AND  Site =  \'{}\' LIMIT {}, {}'.format(session['SiteName'],row1,row2))
                data = cur.fetchall()
                cur.close()
                return render_template('reportes/t_solicituddonacion.html',Datos = session,Infos =data)
            else:
